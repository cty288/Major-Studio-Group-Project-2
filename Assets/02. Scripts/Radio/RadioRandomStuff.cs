...
public class RadioTextMessageInfo {
    ...
    public RadioTextMessageInfo(string Content, float speakSpeed, Gender gender, float triggerChance, RadioChannel radioChannel, int mixerIndex = 1) {
...
public  class RadioRandomStuff :MikroSingleton<RadioRandomStuff>, IController {
    ...
    private  List<Antlr.Runtime.Misc.Func<RadioTextMessageInfo>> _radioMessages = new List<Antlr.Runtime.Misc.Func<RadioTextMessageInfo>>();
    private List<Antlr.Runtime.Misc.Func<RadioTextMessageInfo>> radioMessageCopies = new List<Antlr.Runtime.Misc.Func<RadioTextMessageInfo>>();


    public RadioTextMessageInfo GetNextRandomRadio() {
        radioMessageCopies.CTShuffle();

        RadioTextMessageInfo targetTextMessageInfo = null;

        while (targetTextMessageInfo == null) {
            targetTextMessageInfo = radioMessageCopies[0]();
    ...
    private RadioTextMessageInfo Message1() {
        ...
        return new RadioTextMessageInfo(content, Random.Range(0.8f, 1.2f), Gender.MALE, Random.Range(0.2f, 0.8f), RadioChannel.FM100,1);
    }
    ...
    private RadioTextMessageInfo Message_Weather_Report()
    {
        string content = "Weather report of tomorrow. "
                         ...
                         + " day.";
        return new RadioTextMessageInfo(content, Random.Range(0.8f, 1.2f), Gender.FEMALE, Random.Range(0.2f, 0.8f), RadioChannel.FM100,1);
    }
    ...
    private RadioTextMessageInfo Message_Hacked()
    {
        ...
        return new RadioTextMessageInfo(content, 0.5f, Gender.MALE, 1f, RadioChannel.FM100,4);
    }
    ...
    private RadioTextMessageInfo Message_Military()
    {
        ...
        return new RadioTextMessageInfo(content, 1f, Gender.MALE, 1f, RadioChannel.FM100,1);
    }
    ...
    private RadioTextMessageInfo Message_Christian_Church()
    {
        ...
        return new RadioTextMessageInfo(content, 0.9f, Gender.MALE, 1f, RadioChannel.FM100,1);
    }
    ...
    private RadioTextMessageInfo Message_Research()
    {
        ...
        return new RadioTextMessageInfo(content, 1.2f, Gender.MALE, 1f, RadioChannel.FM100,1);
    }
    ...
    private RadioTextMessageInfo Message_Mayor() {
        ...
        return new RadioTextMessageInfo(content, 1.2f, Gender.MALE, 0.5f, RadioChannel.FM100,1);
    }
    ...
    private RadioTextMessageInfo Message_Suply() {
        ...
        return new RadioTextMessageInfo(content, 1.2f, Gender.MALE, 0.8f,RadioChannel.FM100, 1);
    }
    ...
    private RadioTextMessageInfo Message_KFCVMe50() {
        ...
        return new RadioTextMessageInfo(content, 1.2f, Gender.MALE, chance, RadioChannel.FM100,1);
    }
    private void RegisterRadioMessages(Antlr.Runtime.Misc.Func<RadioTextMessageInfo> message) {
