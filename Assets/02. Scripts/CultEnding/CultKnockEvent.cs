...
namespace _02._Scripts.CultEnding {
	public class CultKnockEvent : BodyGenerationEvent {
		...
		protected override Func<bool> OnOpen() {
			...
			if (refuseTime == 0) {
				message =
					"Hello, I represent a group of individuals who have come to see past this facade of an epidemic. " +
					"Have you heard the call of the Xenovore, my friend? It is the only true path to salvation, to transcendence. " +
					"The government tells you to hide in fear, but in truth they are terrified of this new age to come. " +
					"Join us, we are the <color=yellow>Shadow Sect</color>, and embrace the transformation. Only then can you truly be free.";
			}
			else {
				message =
					"Hello once again, you have done well to survive all this time on your own. Yet surely you must see by now, there is nothing to be gained from this meaningly struggle to subsist. You lack purpose because you serve a lie." +
					"We are so close to reaching the <color=yellow>Xenovore</color>, and in her embrace we will find rebirth. It is not too late, there is still room within our ranks. You can still be saved!";
			}
