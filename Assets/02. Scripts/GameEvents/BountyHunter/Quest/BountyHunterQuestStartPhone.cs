...
public class BountyHunterQuestStartPhone : TelephoneContact, ICanGetModel {
    ...
    protected override void OnStart() {
        ...
        welcome +=
            "I believe it is the <color=yellow>\"Xenovore\"</color> that posted on the newspaper several days ago. I have gathered some information about it, but I still don't know its physical characteristics. " +
