...
public class BountyHunterQuestStartPhone : TelephoneContact {
    ...
    protected override void OnStart() {
        string welcome = "Hey! My friend! This is the bounty hunter! I don¡¯t know what kind of magic you have, but you have successfully helped me capture several aliens." +
        ...
        welcome +=
            "The police launched force to try to arrest it, but it seems to be more stealthy and agile than any other creatures! ";
        welcome +=
