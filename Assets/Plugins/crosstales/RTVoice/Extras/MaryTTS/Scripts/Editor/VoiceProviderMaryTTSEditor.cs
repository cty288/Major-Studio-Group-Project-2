...
namespace Crosstales.RTVoice.MaryTTS
{
   ...
   public class VoiceProviderMaryTTSEditor : Editor
   {
      ...
      private Crosstales.RTVoice.Model.Enum.MaryTTSType type;
      ...
      public override void OnInspectorGUI()
      {
         ...
         type = (Crosstales.RTVoice.Model.Enum.MaryTTSType)EditorGUILayout.EnumPopup(new GUIContent("Type", "Input type for MaryTTS (default: MaryTTSType.RAWMARYXML)."), script.Type);
         if (type != script.Type)
         {
