...
namespace Polyglot
{
    public static class LocalizationImporter
    {
        ...
        public static Action onDownloadCustonSheet;
        public static IEnumerator DownloadCustomSheet(Func<float, bool> progressbar = null)
        {
            ...
            return Download(settings.CustomDocument, s => {
                Import(s, settings.CustomDocument.Format);
                onDownloadCustonSheet?.Invoke();
            }, progressbar);
